      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{URL::to('/add-category')}}">
            <i class="fa fa-th"></i> <span>Add Category</span>
            
          </a>
        </li>
        <li>
          <a href="{{URL::to('/manage-category')}}">
            <i class="fa fa-th"></i> <span>Manage Category</span>
        ...
        <li>
         ...
         <li>
          <a href="{{URL::to('/manage-blog')}}">
            <i class="fa fa-th"></i> <span>Manage Blog</span>
            
          </a>
        </li>
         <li>
          <a href="{{URL::to('/manage-comment')}}">
            <i class="fa fa-th"></i> <span>Manage Comment</span>
